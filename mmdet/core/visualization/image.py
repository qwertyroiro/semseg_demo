...
def draw_labels(
    ...
    for i, (pos, label) in enumerate(zip(positions, labels)):
        ...
        # while True:
        #     try:
        #         label_text = translator.translate(str(label_text), dest='ja', src='en')
        #         break
        #     except Exception as e:
        #         transcounter += 1
        #         if transcounter > 10:
        #             print("transrator_error_10times")
        #         # translator = Translator()
        
        from mmdet.datasets import Dataset_ade_coco
        translate = Dataset_ade_coco.Translate
        # label_text_ja = translate[label_text]
        label_text_ja = label_text
...
def imshow_det_bboxes(
    ...
    if segms is not None:
        ...
        if mask_color == "ade_coco":
            colors = [mask_palette[class_name] for class_name in class_names]
        else:
